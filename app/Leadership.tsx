                            ...
                            <div className="card border-radius-6px border-0 box-shadow-medium-bottom box-shadow-medium-bottom-hover">
                                <div className="blog-image home-leadership-image">
                                    ...
                                    <div className="blog-categories">
                                        <a href="#" className="categories-btn bg-dark-gray-transparent text-white text-uppercase fw-600">Leadership</a>
                                    </div>
                                </div>
                                <div className="card-body p-11">
                                    <a href="demo-blogger-blog-single-classic.html" className="card-title mb-15px fw-600 fs-18 lh-26 text-dark-gray d-inline-block">{leadership.title}</a>
                                    ...
                                    <div className="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-15 text-uppercase">
                                        <div className="me-auto">
                                            ...
                                            <div className="text-dark-gray d-inline-block author-name text-transform-none">By <a href="#" className="text-dark-gray text-decoration-line-bottom fw-600">Andy glamer</a></div>
                                        </div>
